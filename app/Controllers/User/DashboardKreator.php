...
class DashboardKreator extends BaseController
{
    ...
    public function index()
    {
        ...
        // Nilai default yang mencakup SEMUA kunci yang dibutuhkan downstream
        $defaultStats = [
            'peak_ccv'        => 0, 
            'yt_views'        => 0, 'yt_vids'        => 0,
            'tt_views'        => 0, 'tt_vids'        => 0,
            'yt_shorts_views' => 0, 'yt_shorts_vids' => 0,
            'month_views'     => 0,
            'month_vids'      => 0,
            'month_ccv'       => 0,
            'recent_metrics'  => ['peak_ccv' => 0, 'yt_avg' => 0, 'yt_shorts_avg' => 0, 'tt_avg' => 0],
