    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="hud-header d-flex justify-content-between align-items-center flex-wrap py-2 px-3"
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-outline-danger px-3 orbitron" onclick="scrollTable('laporanTable', 'left')" style="font-size: 0.65rem; border-radius: 4px 0 0 4px;">
                        <i class="fas fa-chevron-left mr-1"></i> KIRI
                    </button>
                    <button type="button" class="btn btn-sm btn-danger px-3 orbitron" onclick="scrollTable('laporanTable', 'right')" style="font-size: 0.65rem; background: var(--bs-red); border-radius: 0 4px 4px 0;">
